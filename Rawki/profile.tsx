          ...
          <CardContent className="space-y-6">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Progress
                      ...
                      className={cn(
                        "h-2",
                        needsReup ? "[&>div]:bg-destructive" : "[&>div]:bg-foreground"
                      )}
                    />
            ...
            >
              <Button
                ...
                className="flex-1 bg-foreground text-background hover:bg-foreground/90 shadow-sm"
                size="lg"
              >
...
export default function UserProfileDemo() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <UserProfile
        onPurchaseCredits={() => console.log("Purchase credits clicked")}
