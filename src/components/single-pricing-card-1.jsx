				...
				<div className="relative">
					...
					<motion.div
						...
						<div className="grid md:grid-cols-2 bg-background relative border p-4">
							<PlusIcon className="absolute -top-3 -start-3  size-5.5" />
							<PlusIcon className="absolute -top-3 -end-3 size-5.5" />
							<PlusIcon className="absolute -bottom-3 -start-3 size-5.5" />
							<PlusIcon className="absolute -end-3 -bottom-3 size-5.5" />
