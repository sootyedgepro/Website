    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background:#16242B;border:1px solid #33474F;border-radius:14px;overflow:hidden;">
      ...
      <tr><td style="padding:28px;">
        ...
        <div style="background:linear-gradient(160deg,#1d3a39,#16282e);border:1px solid #0E6E6B;border-radius:12px;padding:22px;margin-bottom:20px;">
          ...
          <a href="https://discord.gg/SZ3n8AcNRT" style="display:inline-block;background:#16B5A6;color:#06231f;font-weight:800;font-size:14px;letter-spacing:.4px;padding:12px 22px;border-radius:10px;text-decoration:none;">Join the Discord →</a>
        </div>
...
Want to go deeper?
Join the SootyEdge Discord: https://discord.gg/SZ3n8AcNRT
